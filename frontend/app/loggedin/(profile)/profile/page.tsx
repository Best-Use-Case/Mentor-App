		...
		<main className='grid grid-cols-2 gap-4 max-w-6xl mx-auto p-4'>
			<section className='flex flex-col col-span-2 md:col-span-1 gap-4 order-2 md:order-2'>
				<section className='grid grid-cols-3 gap-4 p-8 rounded-lg bg-neutral-200 dark:bg-neutral-800 z-0'>
					...
					<div className='relative col-span-1 order-2 h-fit before:block before:absolute before:top-1.5 before:left-2 before:w-full before:h-full before:border-4 before:rounded-full before:border-neutral-950 dark:before:border-neutral-50 before:-z-10'>
						<Image
